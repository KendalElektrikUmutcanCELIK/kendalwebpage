...
const homeBlocks: Record<HomeBlockSlot, PageBlock[]> = homeBlocksJson as Record<
  HomeBlockSlot,
  PageBlock[]
>;
...
export const HOME_BLOCK_SLOTS: { key: HomeBlockSlot; label: string }[] = [
  ...
  {
    key: 'after-brands',
    label: 'Markalarımız ile Şirket İstatistikleri Arasına',
  },
  {
    key: 'after-stats',
    label: 'Şirket İstatistikleri ile Katalog CTA Arasına',
  },
  ...
  {
    key: 'after-global-presence',
    label: 'Küresel Varlık ile Haberler Arasına',
  },
